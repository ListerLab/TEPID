...
breakpoints = locate.filter_split(merged_split)
...
strands = merged_intersections.filter(lambda b: len(b[x]) < 2).saveas('collapsed_intersections.temp')  # set x to column containing collapsed strand info

# python annotate_ins.py
# need way to get accession name
locate.annotate_insertions('collapsed_intersections.temp', 'insertions.bed', name, mn, std)
