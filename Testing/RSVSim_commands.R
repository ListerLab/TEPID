...
ath_insertions_r1 <- with(ins_tair_r1, GRanges(chr, IRanges(start, stop), chrB=dest_chr, startB=dest_start))
ath_insertions_r2 <- with(ins_tair_r2, GRanges(chr, IRanges(start, stop), chrB=dest_chr, startB=dest_start))
ath_insertions_r3 <- with(ins_tair_r3, GRanges(chr, IRanges(start, stop), chrB=dest_chr, startB=dest_start))
ath_insertions_r4 <- with(ins_tair_r4, GRanges(chr, IRanges(start, stop), chrB=dest_chr, startB=dest_start))
ath_insertions_r5 <- with(ins_tair_r5, GRanges(chr, IRanges(start, stop), chrB=dest_chr, startB=dest_start))

brachy_insertions_r1 <- with(ins_brachy_r1, GRanges(chr, IRanges(start, stop), chrB=dest_chr, startB=dest_start))
brachy_insertions_r2 <- with(ins_brachy_r2, GRanges(chr, IRanges(start, stop), chrB=dest_chr, startB=dest_start))
brachy_insertions_r3 <- with(ins_brachy_r3, GRanges(chr, IRanges(start, stop), chrB=dest_chr, startB=dest_start))
brachy_insertions_r4 <- with(ins_brachy_r4, GRanges(chr, IRanges(start, stop), chrB=dest_chr, startB=dest_start))
brachy_insertions_r5 <- with(ins_brachy_r5, GRanges(chr, IRanges(start, stop), chrB=dest_chr, startB=dest_start))
